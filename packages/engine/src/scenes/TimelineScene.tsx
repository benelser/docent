...
// are. Timeline can: the seven years between 1907 and 1914 occupy a visible
// fraction of the axis, and that fraction *is* part of the argument. The gap
// is load-bearing.
//
// The axis spans `axis.start` to `axis.end` (parseable date strings). Ticks
// can be authored explicitly (`axis.ticks`) or auto-spaced. Each event is a
// dated marker; `lane` (0..N) stacks events vertically when they cluster.
// Spans are horizontal bars between two dates — wars, eras, treaty periods.
// `treatment` re-skins for sketch/whiteboard moods, but the geometry holds:
// time runs left-to-right, the dates are real.
