...
// Magnitudes. Either a grid of big-number figure cards (a large mono value,
// unit, a small label above, a note below) or a worked numeric matrix (row and
// column labels around a filled grid). Items reveal progressively.
