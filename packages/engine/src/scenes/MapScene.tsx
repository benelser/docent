...
// A map scene — spatial / topological / geographic representation. Position
// IS the argument: a region's place on the stage carries information, never
// decoration. Two layout modes:
//
