...
// component only; the bare-SVG helpers `fitFontSize` and `truncateForSlot`
// live in ./_helpers.ts). At integration, the integrator replaces this
// file with an import from the shared infra location.
