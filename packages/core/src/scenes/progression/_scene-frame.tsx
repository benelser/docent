...
// time. Inlining a verbatim copy here keeps the progression scene's
// worktree self-contained and `tsc --noEmit` clean.
//
...
// shared path lands as) and deletes this file. The progression component
// reads SceneFrame through `./_scene-frame` so the swap is one import.
