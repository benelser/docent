// Judge dimensions for the `progression` scene.
//
// The v2.5.x engine's judge.ts carries no progression-specific judge
// dimensions. The judge surface today is film-wide: the LLM grader weighs
// the whole film against the survey-template depth bar, with progression
