// Local FittedText — single-line / wrap text fitter, plus the SVG helpers
// `fitFontSize` and `truncateForSlot` the map scene uses to size and clip
// connection labels rendered as SVG `<text>`.
//
