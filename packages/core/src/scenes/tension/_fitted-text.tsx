...
// component only; the SVG helpers are not used by the tension scene and are
// omitted). At integration, the integrator replaces this file with an import
// from the shared infra location.
