...
//
// MIRROR of packages/engine/src/components/FittedText.tsx (the FittedText
// component only; the SVG helpers fitFontSize and truncateForSlot are not
// used by the probe scene and are omitted). At integration, the integrator
// replaces this file with an import from the shared infra location.
