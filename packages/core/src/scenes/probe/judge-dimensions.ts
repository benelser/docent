// Judge dimensions for the `probe` scene.
//
// The v2.5.x engine's judge.ts carries no probe-specific judge dimensions.
// The judge surface today is film-wide: the LLM grader weighs the whole
// film against the survey-template depth bar, with probe scenes counted in
...
// probe-specific judge axis (e.g. "the variations interrogate one
