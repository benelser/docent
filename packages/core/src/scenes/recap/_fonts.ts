...
//
// Only the families the recap scene actually uses (inter for prose chrome,
// mono for kicker / numerals / "surveyed from source · docent" footer).
// Loaded via @remotion/google-fonts so renders are deterministic and
// offline.
//
