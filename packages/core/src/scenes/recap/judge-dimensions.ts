// Judge dimensions for the `recap` scene.
//
// The v2.5.x engine's judge.ts carries no recap-specific judge
...
// recap scenes counted in the same rubric as every other scene type.
//
