// Inlined helpers for the provocation scene.
//
// These mirror the v2.5.x engine's shared `glow` utility. The v3.0 fan-out
// moves each scene into its own directory in @docent/core; the shared
// component infrastructure (SceneFrame, Narration, FittedText, glow, fonts)
...
//
// When the shared-infra migration lands, the provocation scene will import
