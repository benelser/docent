...
// viewer.
//
// Migrated from packages/engine/src/scenes/ProvocationScene.tsx as part of
...
//   - props receive `SceneRenderProps<ProvocationScene>` from @bjelser/kit
...
//     glow) lives as colocated helpers in this scene's directory until the
...
//
// The right ending for a research-frontier or open-policy film: "and this
// is where we don't know yet." A provocation is mutually exclusive with the
// big-idea — a film either COMMITS to a takeaway, or HANDS OFF an open
// question. The validator enforces the position contract (last scene of
// the film) and the mutual exclusion film-wide.
//
...
export const ProvocationSceneComponent: React.FC<
  SceneRenderProps<ProvocationSceneSpec>
> = ({scene, common}) => {
