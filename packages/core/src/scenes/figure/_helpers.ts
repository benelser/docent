// Inlined helpers for the figure scene.
//
// Mirrors the v2.5.x engine's shared `glow` utility and `activeBeatIndex`.
// The v3.0 fan-out moves each scene into its own directory in @docent/core;
// the shared component infrastructure (SceneFrame, Narration, FittedText,
// glow, activeBeatIndex, fonts) will be migrated by separate agents and
...
//
// When the shared-infra migration lands, the figure scene will import these
