// Local FittedText — single-line / wrap text fitter (the React component).
//
// MIRROR of packages/engine/src/components/FittedText.tsx (the
// FittedText component only; the SVG helpers `fitFontSize` and
// `truncateForSlot` live in `./_helpers.ts` alongside the chart-scene
// utilities). At integration, the integrator replaces this file with an
// import from the shared infra location.
