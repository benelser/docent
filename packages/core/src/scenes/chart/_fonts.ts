...
//
// Only the families the chart scene actually uses (inter for prose chrome,
// mono for tick labels and datum readouts). Loaded via @remotion/google-fonts
// so renders are deterministic and offline.
//
