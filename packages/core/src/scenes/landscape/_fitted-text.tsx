...
//
// MIRROR of packages/engine/src/components/FittedText.tsx. The SceneFrame
// chrome (kicker, heading) is the only landscape consumer of the JSX
// component; the SVG helpers (`fitFontSize`, `truncateForSlot`) used by
// the plot labels live next door in `_helpers.ts`. At integration, the
// integrator replaces this file with an import from the shared infra
// location.
