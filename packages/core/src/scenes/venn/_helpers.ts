// Inlined helpers for the venn scene.
//
// These mirror the v2.5.x engine's shared `glow` utility and the scene-
// relative `activeBeatIndex` reader. The v3.0 fan-out moves each scene into
// its own directory in @docent/core; the shared component infrastructure
// (SceneFrame, Narration, FittedText, glow, fonts, activeBeatIndex) will be
...
//
// When the shared-infra migration lands, the venn scene will import these
