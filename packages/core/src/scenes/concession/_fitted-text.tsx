...
// truncateForSlot are not used by the concession scene and are omitted).
// At integration, the integrator replaces this file with an import from
// the shared infra location.
