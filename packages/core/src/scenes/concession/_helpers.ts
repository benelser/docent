// Inlined helpers for the concession scene.
//
// Mirrors the v2.5.x engine's shared `glow` utility and the
// `activeBeatIndex` walk. The v3.0 fan-out moves each scene into its own
// directory in @docent/core; the shared component infrastructure
// (SceneFrame, Narration, FittedText, glow, fonts, activeBeatIndex) will
...
//
// When the shared-infra migration lands, the concession scene will import
