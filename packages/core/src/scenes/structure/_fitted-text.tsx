// FittedText + the bare-numerical helpers (fitFontSize, truncateForSlot).
//
// MIRROR of packages/engine/src/components/FittedText.tsx. At integration the
// integrator replaces this file with a shared import.
...
// The bare-numerical version of fitFont, for callers that render `<text>` (SVG)
// and need to compute a font size without wrapping the element in a React
// component. Same semantics as FittedText's internal shrink.
...
// size. Use for SVG `<text>` where the layout can't carry a CSS ellipsis and
// the font size has already been fixed.
