...
//
// MIRROR of packages/engine/src/components/SceneFrame.tsx. The structure
// scene leans the camera toward focus; this chrome reads the camera state
// so its layers parallax along with it. The depth-fractioned `par(cam,
// depth)` helper takes a fraction of the camera move per layer.
//
// At integration, when the shared-infra migration lands, this file is
