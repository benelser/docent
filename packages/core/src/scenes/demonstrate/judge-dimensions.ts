// Judge dimensions for the `demonstrate` scene.
//
// The v2.5.x engine's judge.ts carries no demonstrate-specific judge
...
// demonstrate scenes counted in the same rubric as every other scene
// type.
//
...
// demonstrate-specific judge axis (e.g. "the clip *shows* what the
