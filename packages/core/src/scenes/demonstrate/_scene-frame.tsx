...
// time. Inlining a verbatim copy here keeps the demonstrate scene's
...
// shared path lands as) and deletes this file. The demonstrate
// component reads SceneFrame through `./_scene-frame` so the swap is one
// import.
